...
class ResourceManager:
    ...
    def __init__(self, fleet_node_id: str = "default",
                 total_cpu: float = 8.0, total_memory_mb: float = 32768.0,
                 total_gpu: int = 0):
    ...
    def allocate(self, task_id: str, cpu_cores: float = 1.0,
                 memory_mb: float = 1024.0, gpu_devices: int = 0) -> Optional[ResourceAllocation]:
    ...
    def get_utilization(self) -> Dict[str, float]:
        ...
        return {
            ...
            "memory": used["memory_mb"] / self.total_memory_mb if self.total_memory_mb > 0 else 0.0,
