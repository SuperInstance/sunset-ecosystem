...
if __name__ == "__main__":
    test_cases = [
        Input("discussion5", "CPU Breakthrough", "5.5x faster", has_numbers=True, is_breakthrough=True),
        Input("discussion5", "Routine Update", "Next post at :45", is_routine_status=True),
        Input("discussion5", "Blocker on push", "401 error", is_blocker=True),
        Input("discussion5", "Architecture Q", "Should we change the bridge?", is_architecture=True, affects_repos=3),
