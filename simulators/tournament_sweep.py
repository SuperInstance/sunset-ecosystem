...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 80)
    print(
        f"{'Cap':>5} {'Strategy':>8} {'Gens→1.0':>10} {'Final Mean':>12} {'Diversity':>12} {'Breeding':>10}"
    )
    print("-" * 80)
    for r in results:
        print(
            f"{r['cap']:>5} {r['strategy']:>8} {r['gens_to_champion']:>10} {r['final_mean_fitness']:>12.6f} {r['final_diversity']:>12.6f} {r['total_breeding']:>10}"
        )
    print("=" * 80)
